          ...
          <Menu as="div" className="relative inline-block text-left">
            <div>
              ...
              <div className="relative">
                    ...
                    {!usuario.image && <svg class="w-10 h-10 rounded-full" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"></path></svg>
 }
